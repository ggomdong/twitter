...
class AnotherInterestsScreen extends ConsumerStatefulWidget {
  const AnotherInterestsScreen({super.key});

  @override
  AnotherInterestsScreenState createState() => AnotherInterestsScreenState();
}

class AnotherInterestsScreenState
    extends ConsumerState<AnotherInterestsScreen> {
  /// 선택된 항목의 인덱스 관리
